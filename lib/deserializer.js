...
Deserializer.prototype.deserializeMethodResponse = function(data, callback) {
    var that = this
...
Deserializer.prototype.deserializeMethodCall = function(data, callback) {
    var that = this
...
Deserializer.prototype.endStruct = function(data) {
    var mark = this.marks.pop(),
        struct = {}, items = this.stack.slice(mark),
        i = 0
